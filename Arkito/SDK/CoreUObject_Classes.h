...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_Z8QM[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_F2LK[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_3NBM5F1168[0x4];                                     // 0x0044(0x0004) PRE-DEFINED PROPERTY
		TArray<unsigned char>                                      Script;                                                  // 0x0048(0x0010) PRE-DEFINED PROPERTY
		int                                                        MinAlignment;                                            // 0x0058(0x0004) PRE-DEFINED PROPERTY
		unsigned char                                              pad_6A1RT7NQCA[0x4];                                     // 0x005C(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_TR9W[0x18];                                  // 0x0090(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SGEM[0x68];                                  // 0x0028(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_C8L3[0xF8];                                  // 0x0090(0x00F8) MISSED OFFSET (PADDING)
	...
	public:
		uint32_t										   FunctionFlags;                                             // 0x0090
		                                          // 0x0090(0x0004) PRE-DEFINED PROPERTY
		uint16_t                                                   RepOffset;                                               // 0x0094(0x0002) PRE-DEFINED PROPERTY
		unsigned char                                              pad_WN9VLTGCCD[0x1];                                     // 0x0096(0x0001) PRE-DEFINED PROPERTY
		unsigned char                                              pad_9H57IS4N6R[0x1];                                     // 0x0097(0x0001) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_NLOQ[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NUEI[0x28];                                  // 0x0030(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZMA4[0x198];                                 // 0x0028(0x0198) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x04C0 (FullSize[0x0680] - InheritedSize[0x01C0])
	 */
	class ULinkerLoad : public ULinker
	{
	public:
		unsigned char                                              UnknownData_51Q0[0x4C0];                                 // 0x01C0(0x04C0) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0128 (FullSize[0x02E8] - InheritedSize[0x01C0])
	 */
	class ULinkerSave : public ULinker
	{
	public:
		unsigned char                                              UnknownData_DKLJ[0x128];                                 // 0x01C0(0x0128) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JY60[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EPKK[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_962B[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DY66[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ADYF[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EVSO[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FTUU[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DCT6[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MKMU[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Z0XT[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3GJY[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8SXF[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
